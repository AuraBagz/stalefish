...
const SEGMENTS = [
  ...
  },
  {
    ...
    desc: "Contracts, engagement letters, redlines, and clause libraries — drafted in the firm's house style and reviewed for common risk flags before the attorney reads the first page. Less time on boilerplate, more time on the deal.",
  ...
  },
  {
    ...
    desc: "Standardized intake, client onboarding correspondence, matter summaries, and status updates — routed through the ethics gate and delivered to the attorney with the record already organized. Matters arrive better-prepared before the lawyer touches the file.",
    tag: "Ops Layer",
    featured: false,
  },
]
...
export default function Industries() {
  return (
    <section id="industries" aria-labelledby="industries-heading" style={{ background: "#f5f5f8", padding: "120px 60px" }}>
        ...
        <div style={{
          ...
          {SEGMENTS.map((seg, i) => {
            ...
            return (
              ...
              >
                {/* "Where we operate" accent on first card */}
                {seg.featured && (
                  <div style={{
